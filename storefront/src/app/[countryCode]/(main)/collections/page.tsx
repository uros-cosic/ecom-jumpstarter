...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const t = await getTranslations("Collections.metadata")
    ...
    return {
        ...
        keywords,
        openGraph: {
            url: new URL(`${countryCode}/collections`, STORE.baseUrl),
            type: 'website',
            title,
            description,
        },
        ...
        alternates: {
            canonical: new URL(`${countryCode}/collections`, STORE.baseUrl),
        }
    }
}
